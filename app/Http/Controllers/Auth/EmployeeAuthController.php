...
class EmployeeAuthController extends Controller
{
    ...
    public function login(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => [
                    'user' => $employee->only('id', 'name', 'nickname', 'employee_code', 'photo', 'company_id', 'has_ot', 'position', 'position_level', 'level', 'department', 'division', 'reports_to', 'role', 'is_active', 'gender'),
                    'token' => $token,
                ],
    ...
    public function verify(Request $request): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $employee->only('id', 'name', 'nickname', 'employee_code', 'photo', 'company_id', 'has_ot', 'position', 'position_level', 'level', 'department', 'division', 'reports_to', 'role', 'is_active', 'gender'),
